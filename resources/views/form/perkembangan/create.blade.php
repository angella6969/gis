    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-body">
                ...
                <div class="card">
                    <div class="card-body">
                        <form method="post" action="/dashboard/update/perkembangan-daerah-irigasi/create/{{ $id }}"
                            ...
                            <div class="mt-3 mb-3">
                                ...
                                <select class="form-select" id="TahunPengerjaan" name="TahunPengerjaan" required>
                            ...
                            <div id="inputLainnyaTahunPengerjaan"
                                ...
                                <input type="text" class="form-control" id="pilihanLainnyaTahunPengerjaan"
                                    name="pilihanLainnyaTahunPengerjaan"
                                    value="{{ old('pilihanLainnyaTahunPengerjaan') }}">
                            </div>

                            <div class="mt-3 mb-3">
                                <label for="jenisPekerjaan" class="form-label">Jenis Pekerjaan</label>
                                <select class="form-select" id="jenisPekerjaan" name="jenisPekerjaan" required>
                                    <option value="">Pilih salah satu opsi</option>
                            ...
                            <div class="mt-3 mb-3">
                                ...
                                <select class="form-select" id="langsirMaterial" name="langsirMaterial" required>
                                    <option value="">Pilih salah satu opsi</option>
